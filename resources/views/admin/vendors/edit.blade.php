...
@section('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBMkD749sssjsayHE8XILcCVUI8ExXpqHs&libraries=places&callback=initAutocomplete&language=ar&region=IQ
         async defer"></script>
@stop
